...
public class StringUtil {
    ...
    public static int countDuplicateWordsOccurrence(String input1, String input2) {
        int occ = 0;
    ...
    public static Boolean stringContains(String sourceStr, String targetStr) {
        ...
        if (isEmpty(sourceStr) && isNotEmpty(targetStr))
            return false;
        if (stringSpaceRemover(sourceStr.toLowerCase()).contains(stringSpaceRemover(targetStr.toLowerCase())))
            return true;
        return stringSpaceRemover(targetStr.toLowerCase()).contains(stringSpaceRemover(sourceStr.toLowerCase()));
    }
